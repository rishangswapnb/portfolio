    ...
    <div className='timeline-container'>
      <div className="recommendation-card">
        ...
        <div className="recommendation-body">
          <p>✨ "It is with great pleasure that I write this reference for Rishang, who worked for us as a software developer at Finance firm . Unfortunately, due to a change in the company’s structure, we have made the difficult decision to make their position redundant. This in no way reflects on their performance, which was consistently excellent.</p>
